...
let trafficData = {
	...
	datasets: [{
		data: [850, 1100, 1000, 2300, 1500, 1800, 1300, 1900, 2400, 1500, 2500],
		borderColor: 'rgb(106, 103, 145)',
		pointRadius: '3',
		borderWidth: '.5',
		tension: '.5'
	}]
...
const trafficOptions = {
	backgroundColor: 'rgba(106, 103, 145, .4)',
	fill: true,
	aspectRatio: 2.5,
	animation: {
		duration: 400,
...
const dailyData = {
	...
	datasets: [{
		...
		backgroundColor: 'rgb(106, 103, 145)',
	}]
};
const dailyOptions = {
	scales: {
